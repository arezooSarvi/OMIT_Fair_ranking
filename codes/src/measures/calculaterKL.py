...
import numpy as np
import math
import codes.src.measures.dataGenerator as dataGenerator
...
NORM_ITERATION=20 # max iterations used in normalizer computation
NORM_FILE="src/measures/normalizer.txt" # externally text file for normalizers
