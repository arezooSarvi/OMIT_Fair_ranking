...
def main_1(dataSetName, fileNames, listNetRanking, outliers_results, queryNumbers, query_seq_file, results, wind):
    ...
    print_final_results(results, outlierResults, '_outlierness_COPOD_window_' + str(wind))
...
def main():
    ...
    for dirpath, dirnames, files in os.walk(data_path):
        ...
        if 'fold' in dirpath:
            ...
            Parallel(n_jobs=2)(delayed(main_1)(dataSetName, fileNames, listNetRanking, outliers_results,
